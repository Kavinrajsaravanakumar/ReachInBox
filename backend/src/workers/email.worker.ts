...
import { emails, senders } from "../db/schema/index.js";
import { logger } from "../utils/logger.js";
import { indexEmail } from "../services/elasticsearch.service.js";
import { sendViaEthereal } from "../services/mail.service.js";
import { EMAIL_QUEUE_NAME, createBullConnection, type EmailJobData } from "../queues/queue.connection.js";
import {
  claimSlackNotify,
...
import { markEmailFailed } from "./worker.utils.js";
...
export function startEmailWorker(): Worker<EmailJobData> {
  const worker = new Worker<EmailJobData>(
    ...
    async (job, token) => {
      ...
      if (!sender) {
        await markEmailFailed(row.id, "Sender no longer exists");
        return;
      }
